...
var UserWhere = struct {
	...
	Discriminator whereHelperstring
	...
	Discriminator: whereHelperstring{field: "`user`.`discriminator`"},
	PasswordHash:  whereHelperstring{field: "`user`.`password_hash`"},
	RegisteredAt:  whereHelpertime_Time{field: "`user`.`registered_at`"},
	LastLogin:     whereHelpernull_Time{field: "`user`.`last_login`"},
...
var (
	userAllColumns            = []string{"id", "username", "discriminator", "password_hash", "registered_at", "last_login", "email"}
	userColumnsWithoutDefault = []string{"id", "username", "discriminator", "password_hash", "registered_at", "last_login", "email"}
